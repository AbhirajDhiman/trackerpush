...
private val DarkColorScheme = darkColorScheme(
    primary = Color(0xFF00E676),        // Vibrant green for success
    onPrimary = Color(0xFF000000),
    primaryContainer = Color(0xFF00C853),
    onPrimaryContainer = Color(0xFFFFFFFF),
    
    secondary = Color(0xFF00B0FF),      // Cyan for accents
    onSecondary = Color(0xFF000000),
    secondaryContainer = Color(0xFF0091EA),
    onSecondaryContainer = Color(0xFFFFFFFF),
    
    tertiary = Color(0xFFFF6E40),       // Orange for warnings
    onTertiary = Color(0xFF000000),
    tertiaryContainer = Color(0xFFFF3D00),
    onTertiaryContainer = Color(0xFFFFFFFF),
    
    error = Color(0xFFFF1744),          // Red for errors
